...
//   2. The seller's show-page URL. Last-resort fallback when there's no
//      per-perf URL, or when date/time are missing.
...
function computeAnalysis(performances, today, showUrlBySeller) {
  ...
  // case matters: if TodayTix and TTD both list a show at £6, both
